...
KNU_LOG_CONSOLE.CHAT_LOG = function(div_scroll, message, talker, width) {
    ...
    if (talker != undefined) {
        ...
        if (KNU_LOG_CONSOLE.CHAT_TOGGLE) {
            div.classList.add('me');
        } else {
            div.classList.add('you');
        }
        KNU_LOG_CONSOLE.CHAT_TOGGLE = !KNU_LOG_CONSOLE.CHAT_TOGGLE;
    }
    if (width != undefined) {
